...
export const markets = {
  ...
  tollywood: [
    ...
    },
    {
      ...
      description: 'Predict if Allu Arjun\'s Pushpa 2 will cross ₹1000 crore worldwide box office collection within first 30 days of release.',
      endDate: '2024-09-15',
      category: 'tollywood',
      volume: '₹2.5M',
      yesPrice: '0.65',
    ...
    },
    {
      ...
      description: 'Predict if Prabhas starrer Kalki 2898 AD will have its theatrical release before September 2024.',
      endDate: '2024-09-01',
      category: 'tollywood',
      volume: '₹1.8M',
      yesPrice: '0.45',
    ...
    },
    {
      ...
      description: 'Predict if Jr NTR\'s Devara Part 1 will collect more than ₹50 crores net in India on its opening day.',
      endDate: '2024-10-11',
      category: 'tollywood',
      volume: '₹2.1M',
      yesPrice: '0.72',
    ...
    },
    {
      ...
      description: 'Predict if Ram Charan\'s political thriller Game Changer will release before the 2024 Indian general elections.',
      endDate: '2024-04-30',
      category: 'tollywood',
      volume: '₹1.5M',
      yesPrice: '0.38',
    ...
    },
    {
      ...
      description: 'Predict if Pushpa 2: The Rule will win at least one National Film Award in any category for the year 2024.',
      endDate: '2025-08-01',
      category: 'tollywood',
      volume: '₹900K',
      yesPrice: '0.58',
    ...
    },
    {
      ...
      description: 'Predict if Kalki 2898 AD\'s VFX budget will exceed RRR\'s reported VFX budget of ₹150 crores.',
      endDate: '2024-12-31',
      category: 'tollywood',
      volume: '₹1.2M',
      yesPrice: '0.75',
    ...
    },
    {
      ...
      description: 'Predict if Jr NTR\'s Devara will collect more than $10 million at the United States box office.',
      endDate: '2024-11-15',
      category: 'tollywood',
      volume: '₹1.6M',
      yesPrice: '0.68',
    ...
    },
    {
      ...
      description: 'Predict if Ram Charan\'s Game Changer will receive an IMDb rating higher than 8.0 within first month of release.',
      endDate: '2024-12-31',
      category: 'tollywood',
      volume: '₹800K',
      yesPrice: '0.42',
    ...
    },
    {
      ...
      description: 'Predict if Pushpa 2 will break the existing first-day worldwide collection record for an Indian film.',
      endDate: '2024-08-16',
      category: 'tollywood',
      volume: '₹2.8M',
      yesPrice: '0.62',
    ...
    },
    {
      ...
      description: 'Predict if major film critics and media will label Kalki 2898 AD as Prabhas\'s biggest comeback after Baahubali series.',
      endDate: '2024-12-31',
      category: 'tollywood',
      volume: '₹1.4M',
      yesPrice: '0.55',
